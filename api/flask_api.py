...
# Uncomment when done:
from resources.brevet import Brevet_R
from resources.brevets import Brevets_R
...
api.add_resource(Brevet_R, "/api/brevet/<id>")
api.add_resource(Brevets_R, "/api/brevets")
